...
const Services = () => {
  ...
  {services.map((service) => {
    ...
    return (
      ...
      >
        {/* Background Glow */}
        <div className="absolute -right-20 -top-20 h-48 w-48 rounded-full bg-cyan-300/20 blur-3xl opacity-0 transition-all duration-500 group-hover:opacity-100"></div>
        ...
        <div className="mt-8 h-1 w-14 rounded-full bg-l inear-to-r from-cyan-400 to-sky-500 transition-all duration-500 group-hover:w-full"></div>
