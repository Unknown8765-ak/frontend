...
const Hero = ({ blogs }) => {
    ...
    return (
        <section className="relative overflow-hidden bg-linear-to-br from-slate-50 via-white to-blue-50">
            ...
            {/* Background Blur */}
            <div className="absolute -left-24 top-10 h-80 w-80 rounded-full bg-blue-200/30 blur-3xl"></div>
            <div className="absolute right-0 top-0 h-96 w-96 rounded-full bg-indigo-200/30 blur-3xl"></div>
            <div className="absolute bottom-0 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-cyan-200/20 blur-3xl"></div>
    ...
    Grow Your Business.
                ...
                <p className="mx-auto mt-10 max-w-3xl text-xl leading-9 text-slate-600">
                    ...
                    Discover expert guides, practical tutorials,
                    business strategies, solar solutions,
                    aquarium knowledge, and digital marketing
                    insights — all designed to help you learn,
